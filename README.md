...
<div align="center">
  ...
  |    Cheng Wang    |  25%  | fd24967@bristol.ac.uk   | **coding**: prop and obstacle, map boundary warning effect, return logic for game menus and button animations, addition of sound effects and background music, partial involvement in debugging.<br>**report**: sustainability and conclusion<br>**designer**: designed core gameplay mechanics, such as winning conditions and difficulty settings.<br>**video**: animation, sounds and video editing.|
