...
<div align="center">
  ...
  |    Xing Yang     |  1   | zj24404@bristol.ac.uk   | **coding**: OOP code architecture, basic gaming functionality, snake base class definition, architecture and logic of playersnake, interaction between playersnake and AI snake, teleport terrain, dessert terrain, banner prompts mechanism, bug fixes<br>**report**: design and evaluation<br>**optimizor**: test before code submission, write test cases, discover and manage game bugs, and optimize game mechanics<br>**assignments**: finish team homework of week 4, week 5, week8 and week 9<br>**video**: write detailed scripts and plan storyboards   |
